<%@ Page Title="" Language="C#" MasterPageFile="~/public/visitormaster.Master" AutoEventWireup="true" CodeBehind="title.aspx.cs" Inherits="online_movie_ticket.title" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="publicassets/csshm/style-starter.css"/>
    <link href="http://localhost:35795/fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,600;0,700;1,600&amp;display=swap"
		rel="stylesheet"/>
</asp:Content>
					...
					<div class="owl-team owl-carousel owl-theme">
						<div class="item vhny-grid">
							<div class="d-grid team-info">
								<div class="column position-relative">
									<a href="#url"><%--<img src="assets/images/a1.jpg"--%><img src="publicassets/imageshm/a1.jpg"  alt="" class="img-fluid rounded team-image" /></a>
								</div>
						...
						<div class="item vhny-grid">
							<div class="box16">
								<div class="d-grid team-info">
									<div class="column position-relative">
										<a href="#url"><img src="publicassets/imageshm/a2.jpg" alt="" class="img-fluid rounded team-image" /></a>
									</div>
									<div class="column text-center">
						...
						<div class="item vhny-grid">
							<div class="box16">
								<div class="d-grid team-info">
									<div class="column position-relative">
										<a href="#url"><img src="publicassets/imageshm/a3.jpg" alt="" class="img-fluid rounded team-image" /></a>
									</div>
									<div class="column text-center">
						...
						<div class="item vhny-grid">
							<div class="box16">
								<div class="d-grid team-info">
									<div class="column position-relative">
										<a href="#url"><img src="publicassets/imageshm/a4.jpg" alt="" class="img-fluid rounded team-image" /></a>
									</div>
									<div class="column text-center">
						...
						<div class="item vhny-grid">
							<div class="box16">
								<div class="d-grid team-info">
									<div class="column position-relative">
										<a href="#url"><img src="publicassets/imageshm/a5.jpg" alt="" class="img-fluid rounded team-image" /></a>
									</div>
									<div class="column text-center">
						...
						<div class="item vhny-grid">
							<div class="box16">
								<div class="d-grid team-info">
									<div class="column position-relative">
										<a href="#url">
                                            <img src="publicassets/imageshm/a3.jpg" /><img src="publicassets/imageshm/a3.jpg" alt="" class="img-fluid rounded team-image" /></a>
									</div>
									<div class="column text-center">
										<h3 class="name-pos"><a href="#url">Chris Hemsworth</a></h3>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="publicassets/imageshm/team1.jpg" class="img-fluid" alt="/">
                                    </div>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="publicassets/imageshm/team2.jpg" class="img-fluid" alt="/">
                                    </div>
                                    <div class="peopl align-self">
                                        <h3>Alexander leo</h3>
                                        <p class="indentity">Washington</p>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="publicassets/imageshm/team3.jpg" class="img-fluid" alt="/">
                                    </div>
                                    <div class="peopl align-self">
                                        <h3>Roy Linderson</h3>
                                        <p class="indentity">Washington</p>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="publicassets/imageshm/team4.jpg" class="img-fluid" alt="/">
                                    </div>
                                    <div class="peopl align-self">
                                        <h3>Mike Thyson</h3>
                                        <p class="indentity">Washington</p>
					...
					<div class="owl-three owl-carousel owl-theme">
						<div class="item vhny-grid">
							<div class="box16">
								<a href="genre.html">
									<figure>
										<img class="img-fluid" src="publicassets/imageshm/m12.jpg" alt=""/>
									</figure>
						...
						<div class="item vhny-grid">
							<div class="box16">
								<a href="genre.html">
									<figure>
										<img class="img-fluid" src="publicassets/imageshm/m11.jpg" alt=""/>
									</figure>
									<div class="box-content">
						...
						<div class="item vhny-grid">
							<div class="box16">
								<a href="genre.html">
									<figure>
										<img class="img-fluid" src="publicassets/imageshm/m9.jpg" alt=""/>
									</figure>
									<div class="box-content">
						...
						<div class="item vhny-grid">
							<div class="box16">
								<a href="genre.html">
									<figure>
										<img class="img-fluid" src="publicassets/imageshm/m8.jpg" alt="">
									</figure>
									<div class="box-content">
						...
						<div class="item vhny-grid">
							<div class="box16">
								<a href="genre.html">
									<figure>
										<img class="img-fluid" src="publicassets/imageshm/m1.jpg" alt="">
									</figure>
									<div class="box-content">
						...
						<div class="item vhny-grid">
							<div class="box16">
								<a href="genre.html">
									<figure>
										<img class="img-fluid" src="publicassets/imageshm/m2.jpg" alt="">
									</figure>
									<div class="box-content">
						...
						<div class="right-side">
							<div class="row footer-about">
								<div class="col-md-3 col-6 footer-img mb-lg-0 mb-4">
									<a href="genre.html"><img class="img-fluid" src="publicassets/imageshm/banner1.jpg"
											alt=""></a>
								</div>
								<div class="col-md-3 col-6 footer-img mb-lg-0 mb-4">
									<a href="genre.html"><img class="img-fluid" src="publicassets/imageshm/banner2.jpg"
											alt=""></a>
								</div>
								<div class="col-md-3 col-6 footer-img mb-lg-0 mb-4">
									<a href="genre.html"><img class="img-fluid" src="publicassets/imageshm/banner3.jpg"
											alt=""></a>
								</div>
								<div class="col-md-3 col-6 footer-img mb-lg-0 mb-4">
									<a href="genre.html"><img class="img-fluid" src="publicassets/imageshm/banner4.jpg"
											alt=""></a>
								</div>
							</div>
