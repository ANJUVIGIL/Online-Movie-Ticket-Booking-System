<%@ Page Title="" Language="C#" MasterPageFile="~/public/visitormaster.Master" AutoEventWireup="true" CodeBehind="booking.aspx.cs" Inherits="online_movie_ticket.booking" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  ...
  <%--  <link rel="stylesheet" href="css/style.css" type="text/css" media="all">--%>
    <link href="publicassets/cssm/style.css" rel="stylesheet" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%--<script src="js/jquery-2.2.3.min.js"></script>--%>
        <script src="publicassets/jsm/jquery-2.2.3.min.js"></script>
    <!-- //js -->
